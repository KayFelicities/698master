...
class Data698():
    def __init__(self, kay):
        ...
        [
            ...
            ('2140', '月最大有功功率及发生时间', '2', '变量类', '属性', '2', '', '月最大有功功率及发生时间:array:structure{最大功率值:double-long-unsigned<kW|-4>,发生时间:date_time_s},'),
            ...
            ('6000', '采集档案配置表', '11', '采集监控类', '方法', '127', 'Add(采集档案配置单元)', 'array:采集档案配置单元:structure{配置序号:long-unsigned,基本信息:structure{通信地址:TSA,波特率:enum[300bps<0>,600bps<1>,1200bps<2>,2400bps<3>,4800bps<4>,7200bps<5>,9600bps<6>,19200bps<7>,38400bps<8>,57600bps<9>,115200bps<10>,自适应<255>],规约类型:enum[未知(0),DL/T645-1997<1>,DL/T645-2007<2>,DL/T698.45<3>,CJ/T188-2004<4>],端口:OAD,通信密码:octet-string,费率个数:unsigned,用户类型:unsigned,接线方式:enum[未知<0>,单相<1>,三相三线<2>,三相四线<3>],额定电压:long-unsigned<V|-1>,额定电流:long-unsigned<A|-1>},扩展信息:structure{采集器地址:TSA,资产号:octet-string,PT:long-unsigned,CT:long-unsigned},附属信息:array:structure{对象属性描述:OAD,属性值:Data}},'),
            ...
            ('6014', '普通采集方案集', '11', '采集监控类', '方法', '127', 'Add(array 普通采集方案)', 'array:普通采集方案:structure{方案编号:unsigned,存储深度:long-unsigned,采集方式:structure{采集类型:unsigned,采集内容:Data},记录列选择:array:CSD,电能表集合:MS,存储时标选择:enum[未定义<0>,任务开始时间<1>,相对当日0点0分<2>,相对上日23点59分<3>,相对上日0点0分<4>,相对当月1日0点0分<5>,数据冻结时标<6>相对上月月末0点0分<7>]},'),
