...
[
    ...
    ('2', '属性', '2', 'dyn.', '总及费率最大需量数组', 'array:structure{最大需量值CHOICE,发生时间:date_time_s}最大需量值：CHOICE{:double-long[5],:double-long-unsigned[6]}'),
    ...
    ('5', '属性', '2', 'dyn.', 'A 相 n 次数值组', 'array:instance-specific'),
    ('5', '属性', '3', 'dyn.', 'B 相 n 次数值组', 'array:instance-specific'),
    ('5', '属性', '4', 'dyn.', 'C 相 n 次数值组', 'array:instance-specific'),
    ...
    ('7', '属性', '8', 'static', '上报标识', ':enum[不上报<0>,事件发生上报<1>,事件恢复上报<2>,事件发生恢复均上报<3>]'),
    ('7', '属性', '9', 'static', '有效标识', 'bool'),
    ('7', '方法', '1', '', '复位', 'integer'),
    ('7', '方法', '2', '', '执行', 'Data'),
    ('7', '方法', '3', '', '触发一次记录', 'instance-specificlong-unsigned'),
    ...
    ('9', '方法', '6', '', '触发数据补冻结（截止时间）', 'DATETIME_S'),
    ('9', '方法', '7', '', '批量添加冻结对象属性（ array 冻结对象）', ''),
    ('9', '方法', '8', '', '清除关联对象属性表（参数） 参数∷ =NULL', ''),
    ...
    ('21', '方法', '1', '', '复位', 'integer'),
    ('21', '方法', '2', '', '执行', 'Data'),
    ('21', '方法', '3', '', 'ESAM 数据读取', 'SIDoctet-string'),
    ('21', '方法', '4', '', '数据更新', 'structure{参数内容:octet-string,数据验证码:SID_MAC}'),
    ('21', '方法', '5', '', '协商失效', 'NULL当前日期时间'),
    ...
    ('23', '属性', '13', 'static', '总加组滑差时间周期', 'unsigned'),
    ('23', '属性', '14', 'static', '总加组功控轮次配置', 'bit-string'),
    ('23', '属性', '15', 'static', '总加组电控轮次配置', 'bit-string'),
    ('23', '属性', '16', 'dyn.', '总加组控制设置状态', 'structure{时段控定值方案号:unsigned,功控时段有效标志位:bit-string(SIZE(8)),功控状态PCState,电控状态ECState,功控轮次状态TrunState,电控轮次状态TrunState}'),
    ('23', '属性', '17', 'dyn.', '总加组当前控制状态', 'structure{当前功控定值:long64(单位：W换算：-1),当前功率下浮控浮动系数:integer(单位：%),功控跳闸输出状态OutputState,月电控跳闸输出状态OutputState,购电控跳闸输出状态OutputState,功控越限告警状态PCAlarmState,电控越限告警状态ECAlarmState}'),
    ('23', '属性', '18', 'static', '换算及单位', 'structure{属性3单位换算:Scaler_Unit,属性4单位换算:Scaler_Unit,属性5单位换算:Scaler_Unit,属性6单位换算:Scaler_Unit,属性7单位换算:Scaler_Unit,属性8单位换算:Scaler_Unit,属性9单位换算:Scaler_Unit,属性10单位换算:Scaler_Unit,属性11单位换算:Scaler_Unit,属性12单位换算:Scaler_Unit}单位'),
    ('23', '方法', '1', '', '清空总加配置单元', 'NULL'),
    ('23', '方法', '2', '', '执行', 'Data'),
    ('23', '方法', '3', '', '添加一个总加配置单元', '总加配置单元'),
    ('23', '方法', '4', '', '批量添加总加配置单元', 'array:array'),
    ('23', '方法', '5', '', '删除一个总加配置单元', '参与总加的分路通信地址'),
...
[
    ...
    ('1010', '正向有功最大需量', '2', '最大需量类', '属性', '2', '', '正向有功最大需量:array:double-long-unsigned<kW|-4>,'),
    ('1011', 'A相正向有功最大需量', '2', '最大需量类', '属性', '2', '', 'A相正向有功最大需量:array:double-long-unsigned<kW|-4>,'),
    ('1012', 'B相正向有功最大需量', '2', '最大需量类', '属性', '2', '', 'B相正向有功最大需量:array:double-long-unsigned<kW|-4>,'),
    ('1013', 'C相正向有功最大需量', '2', '最大需量类', '属性', '2', '', 'C相正向有功最大需量:array:double-long-unsigned<kW|-4>,'),
    ('1020', '反向有功最大需量', '2', '最大需量类', '属性', '2', '', '反向有功最大需量:array:double-long-unsigned<kW|-4>,'),
    ('1021', 'A相反向有功最大需量', '2', '最大需量类', '属性', '2', '', 'A相反向有功最大需量:array:double-long-unsigned<kW|-4>,'),
    ('1022', 'B相反向有功最大需量', '2', '最大需量类', '属性', '2', '', 'B相反向有功最大需量:array:double-long-unsigned<kW|-4>,'),
    ('1023', 'C相反向有功最大需量', '2', '最大需量类', '属性', '2', '', 'C相反向有功最大需量:array:double-long-unsigned<kW|-4>,'),
    ('1030', '组合无功1最大需量', '2', '最大需量类', '属性', '2', '', '组合无功1最大需量:array:double-long<kvar|-4>,'),
    ('1031', 'A相组合无功1最大需量', '2', '最大需量类', '属性', '2', '', 'A相组合无功1最大需量:array:double-long<kvar|-4>,'),
    ('1032', 'B相组合无功1最大需量', '2', '最大需量类', '属性', '2', '', 'B相组合无功1最大需量:array:double-long<kvar|-4>,'),
    ('1033', 'C相组合无功1最大需量', '2', '最大需量类', '属性', '2', '', 'C相组合无功1最大需量:array:double-long<kvar|-4>,'),
    ('1040', '组合无功2最大需量', '2', '最大需量类', '属性', '2', '', '组合无功2最大需量:array:double-long<kvar|-4>,'),
    ('1041', 'A相组合无功2最大需量', '2', '最大需量类', '属性', '2', '', 'A相组合无功2最大需量:array:double-long<kvar|-4>,'),
    ('1042', 'B相组合无功2最大需量', '2', '最大需量类', '属性', '2', '', 'B相组合无功2最大需量:array:double-long<kvar|-4>,'),
    ('1043', 'C相组合无功2最大需量', '2', '最大需量类', '属性', '2', '', 'C相组合无功2最大需量:array:double-long<kvar|-4>,'),
    ('1050', '第一象限最大需量', '2', '最大需量类', '属性', '2', '', '第一象限最大需量:array:double-long-unsigned<kvar|-4>,'),
    ('1051', 'A相第一象限最大需量', '2', '最大需量类', '属性', '2', '', 'A相第一象限最大需量:array:double-long-unsigned<kvar|-4>,'),
    ('1052', 'B相第一象限最大需量', '2', '最大需量类', '属性', '2', '', 'B相第一象限最大需量:array:double-long-unsigned<kvar|-4>,'),
    ('1053', 'C相第一象限最大需量', '2', '最大需量类', '属性', '2', '', 'C相第一象限最大需量:array:double-long-unsigned<kvar|-4>,'),
    ('1060', '第二象限最大需量', '2', '最大需量类', '属性', '2', '', '第二象限最大需量:array:double-long-unsigned<kvar|-4>,'),
    ('1061', 'A相第二象限最大需量', '2', '最大需量类', '属性', '2', '', 'A相第二象限最大需量:array:double-long-unsigned<kvar|-4>,'),
    ('1062', 'B相第二象限最大需量', '2', '最大需量类', '属性', '2', '', 'B相第二象限最大需量:array:double-long-unsigned<kvar|-4>,'),
    ('1063', 'C相第二象限最大需量', '2', '最大需量类', '属性', '2', '', 'C相第二象限最大需量:array:double-long-unsigned<kvar|-4>,'),
    ('1070', '第三象限最大需量', '2', '最大需量类', '属性', '2', '', '第三象限最大需量:array:double-long-unsigned<kvar|-4>,'),
    ('1071', 'A相第三象限最大需量', '2', '最大需量类', '属性', '2', '', 'A相第三象限最大需量:array:double-long-unsigned<kvar|-4>,'),
    ('1072', 'B相第三象限最大需量', '2', '最大需量类', '属性', '2', '', 'B相第三象限最大需量:array:double-long-unsigned<kvar|-4>,'),
    ('1073', 'C相第三象限最大需量', '2', '最大需量类', '属性', '2', '', 'C相第三象限最大需量:array:double-long-unsigned<kvar|-4>,'),
    ('1080', '第四象限最大需量', '2', '最大需量类', '属性', '2', '', '第四象限最大需量:array:double-long-unsigned<kvar|-4>,'),
    ('1081', 'A相第四象限最大需量', '2', '最大需量类', '属性', '2', '', 'A相第四象限最大需量:array:double-long-unsigned<kvar|-4>,'),
    ('1082', 'B相第四象限最大需量', '2', '最大需量类', '属性', '2', '', 'B相第四象限最大需量:array:double-long-unsigned<kvar|-4>,'),
    ('1083', 'C相第四象限最大需量', '2', '最大需量类', '属性', '2', '', 'C相第四象限最大需量:array:double-long-unsigned<kvar|-4>,'),
    ('1090', '正向视在最大需量', '2', '最大需量类', '属性', '2', '', '正向视在最大需量:array:double-long-unsigned<kVA|-4>,'),
    ('1091', 'A相正向视在最大需量', '2', '最大需量类', '属性', '2', '', 'A相正向视在最大需量:array:double-long-unsigned<kVA|-4>,'),
    ('1092', 'B相正向视在最大需量', '2', '最大需量类', '属性', '2', '', 'B相正向视在最大需量:array:double-long-unsigned<kVA|-4>,'),
    ('1093', 'C相正向视在最大需量', '2', '最大需量类', '属性', '2', '', 'C相正向视在最大需量:array:double-long-unsigned<kVA|-4>,'),
    ('10A0', '反向视在最大需量', '2', '最大需量类', '属性', '2', '', '反向视在最大需量:array:double-long-unsigned<kVA|-4>,'),
    ('10A1', 'A相反向视在最大需量', '2', '最大需量类', '属性', '2', '', 'A相反向视在最大需量:array:double-long-unsigned<kVA|-4>,'),
    ('10A2', 'B相反向视在最大需量', '2', '最大需量类', '属性', '2', '', 'B相反向视在最大需量:array:double-long-unsigned<kVA|-4>,'),
    ('10A3', 'C相反向视在最大需量', '2', '最大需量类', '属性', '2', '', 'C相反向视在最大需量:array:double-long-unsigned<kVA|-4>,'),
    ('1110', '冻结周期内正向有功最大需量', '2', '最大需量类', '属性', '2', '', '冻结周期内正向有功最大需量:array:double-long-unsigned<kW|-4>,'),
    ('1111', '冻结周期内A相正向有功最大需量', '2', '最大需量类', '属性', '2', '', '冻结周期内A相正向有功最大需量:array:double-long-unsigned<kW|-4>,'),
    ('1112', '冻结周期内B相正向有功最大需量', '2', '最大需量类', '属性', '2', '', '冻结周期内B相正向有功最大需量:array:double-long-unsigned<kW|-4>,'),
    ('1113', '冻结周期内C相正向有功最大需量', '2', '最大需量类', '属性', '2', '', '冻结周期内C相正向有功最大需量:array:double-long-unsigned<kW|-4>,'),
    ('1120', '冻结周期内反向有功最大需量', '2', '最大需量类', '属性', '2', '', '冻结周期内反向有功最大需量:array:double-long-unsigned<kW|-4>,'),
    ('1121', '冻结周期内A相反向有功最大需量', '2', '最大需量类', '属性', '2', '', '冻结周期内A相反向有功最大需量:array:double-long-unsigned<kW|-4>,'),
    ('1122', '冻结周期内B相反向有功最大需量', '2', '最大需量类', '属性', '2', '', '冻结周期内B相反向有功最大需量:array:double-long-unsigned<kW|-4>,'),
    ('1123', '冻结周期内C相反向有功最大需量', '2', '最大需量类', '属性', '2', '', '冻结周期内C相反向有功最大需量:array:double-long-unsigned<kW|-4>,'),
    ('1130', '冻结周期内组合无功1最大需量', '2', '最大需量类', '属性', '2', '', '冻结周期内组合无功1最大需量:array:double-long<kvar|-4>,'),
    ('1131', '冻结周期内A相组合无功1最大需量', '2', '最大需量类', '属性', '2', '', '冻结周期内A相组合无功1最大需量:array:double-long<kvar|-4>,'),
    ('1132', '冻结周期内B相组合无功1最大需量', '2', '最大需量类', '属性', '2', '', '冻结周期内B相组合无功1最大需量:array:double-long<kvar|-4>,'),
    ('1133', '冻结周期内冻结周期内C相组合无功1最大需量', '2', '最大需量类', '属性', '2', '', '冻结周期内冻结周期内C相组合无功1最大需量:array:double-long<kvar|-4>,'),
    ('1140', '冻结周期内组合无功2最大需量', '2', '最大需量类', '属性', '2', '', '冻结周期内组合无功2最大需量:array:double-long<kvar|-4>,'),
    ('1141', '冻结周期内A相组合无功2最大需量', '2', '最大需量类', '属性', '2', '', '冻结周期内A相组合无功2最大需量:array:double-long<kvar|-4>,'),
    ('1142', '冻结周期内B相组合无功2最大需量', '2', '最大需量类', '属性', '2', '', '冻结周期内B相组合无功2最大需量:array:double-long<kvar|-4>,'),
    ('1143', '冻结周期内C相组合无功2最大需量', '2', '最大需量类', '属性', '2', '', '冻结周期内C相组合无功2最大需量:array:double-long<kvar|-4>,'),
    ('1150', '冻结周期内第一象限最大需量', '2', '最大需量类', '属性', '2', '', '冻结周期内第一象限最大需量:array:double-long-unsigned<kvar|-4>,'),
    ('1151', '冻结周期内A相第一象限最大需量', '2', '最大需量类', '属性', '2', '', '冻结周期内A相第一象限最大需量:array:double-long-unsigned<kvar|-4>,'),
    ('1152', '冻结周期内B相第一象限最大需量', '2', '最大需量类', '属性', '2', '', '冻结周期内B相第一象限最大需量:array:double-long-unsigned<kvar|-4>,'),
    ('1153', '冻结周期内C相第一象限最大需量', '2', '最大需量类', '属性', '2', '', '冻结周期内C相第一象限最大需量:array:double-long-unsigned<kvar|-4>,'),
    ('1160', '冻结周期内第二象限最大需量', '2', '最大需量类', '属性', '2', '', '冻结周期内第二象限最大需量:array:double-long-unsigned<kvar|-4>,'),
    ('1161', '冻结周期内A相第二象限最大需量', '2', '最大需量类', '属性', '2', '', '冻结周期内A相第二象限最大需量:array:double-long-unsigned<kvar|-4>,'),
    ('1162', '冻结周期内B相第二象限最大需量', '2', '最大需量类', '属性', '2', '', '冻结周期内B相第二象限最大需量:array:double-long-unsigned<kvar|-4>,'),
    ('1163', '冻结周期内C相第二象限最大需量', '2', '最大需量类', '属性', '2', '', '冻结周期内C相第二象限最大需量:array:double-long-unsigned<kvar|-4>,'),
    ('1170', '冻结周期内第三象限最大需量', '2', '最大需量类', '属性', '2', '', '冻结周期内第三象限最大需量:array:double-long-unsigned<kvar|-4>,'),
    ('1171', '冻结周期内A相第三象限最大需量', '2', '最大需量类', '属性', '2', '', '冻结周期内A相第三象限最大需量:array:double-long-unsigned<kvar|-4>,'),
    ('1172', '冻结周期内B相第三象限最大需量', '2', '最大需量类', '属性', '2', '', '冻结周期内B相第三象限最大需量:array:double-long-unsigned<kvar|-4>,'),
    ('1173', '冻结周期内C相第三象限最大需量', '2', '最大需量类', '属性', '2', '', '冻结周期内C相第三象限最大需量:array:double-long-unsigned<kvar|-4>,'),
    ('1180', '冻结周期内第四象限最大需量', '2', '最大需量类', '属性', '2', '', '冻结周期内第四象限最大需量:array:double-long-unsigned<kvar|-4>,'),
    ('1181', '冻结周期内A相第四象限最大需量', '2', '最大需量类', '属性', '2', '', '冻结周期内A相第四象限最大需量:array:double-long-unsigned<kvar|-4>,'),
    ('1182', '冻结周期内B相第四象限最大需量', '2', '最大需量类', '属性', '2', '', '冻结周期内B相第四象限最大需量:array:double-long-unsigned<kvar|-4>,'),
    ('1183', '冻结周期内C相第四象限最大需量', '2', '最大需量类', '属性', '2', '', '冻结周期内C相第四象限最大需量:array:double-long-unsigned<kvar|-4>,'),
    ('1190', '冻结周期内正向视在最大需量', '2', '最大需量类', '属性', '2', '', '冻结周期内正向视在最大需量:array:double-long-unsigned<kVA|-4>,'),
    ('1191', '冻结周期内A相正向视在最大需量', '2', '最大需量类', '属性', '2', '', '冻结周期内A相正向视在最大需量:array:double-long-unsigned<kVA|-4>,'),
    ('1192', '冻结周期内B相正向视在最大需量', '2', '最大需量类', '属性', '2', '', '冻结周期内B相正向视在最大需量:array:double-long-unsigned<kVA|-4>,'),
    ('1193', '冻结周期内冻结周期内C相正向视在最大需量', '2', '最大需量类', '属性', '2', '', '冻结周期内冻结周期内C相正向视在最大需量:array:double-long-unsigned<kVA|-4>,'),
    ('11A0', '冻结周期内反向视在最大需量', '2', '最大需量类', '属性', '2', '', '冻结周期内反向视在最大需量:array:double-long-unsigned<kVA|-4>,'),
    ('11A1', '冻结周期内A相反向视在最大需量', '2', '最大需量类', '属性', '2', '', '冻结周期内A相反向视在最大需量:array:double-long-unsigned<kVA|-4>,'),
    ('11A2', '冻结周期内B相反向视在最大需量', '2', '最大需量类', '属性', '2', '', '冻结周期内B相反向视在最大需量:array:double-long-unsigned<kVA|-4>,'),
    ('11A3', '冻结周期内C相反向视在最大需量', '2', '最大需量类', '属性', '2', '', '冻结周期内C相反向视在最大需量:array:double-long-unsigned<kVA|-4>,'),
    ...
    ('200A', '功率因数', '4', '变量类', '属性', '2', '', '功率因数:array:long<无|-3>,'),
    ...
    ('2013', '时钟电池工作时间', '6', '变量类', '属性', '2', '', '时钟电池工作时间:double-long-unsigned<分钟|>,'),
    ...
    ('2029', '安时值', '6', '变量类', '属性', '2', '安时数值', '安时数值:array 相安时值<Ah|-2>,'),
    ...
    ('2130', '总电压合格率', '6', '变量类', '属性', '2', '电压合格率数据', '电压合格率数据:structure{当日电压合格率电压合格率,当月电压合格率电压合格率}电压合格率∷=:structure{电压监测时间:double-long-unsigned<分钟,0>,电压合格率:long-unsigned<%,-2>,电压超限率:long-unsigned<%,-2>,电压超上限时间:double-long-unsigned<分钟,0>,电压超下限时间:double-long-unsigned<分钟,0>},'),
    ('2131', '当月A相电压合格率', '6', '变量类', '属性', '0', '', ''),
    ('2132', '当月B相电压合格率', '6', '变量类', '属性', '0', '', ''),
    ('2133', '当月C相电压合格率', '6', '变量类', '属性', '0', '', ''),
    ('2140', '日最大有功功率及发生时间', '2', '变量类', '属性', '2', '', '日最大有功功率及发生时间:array:structure{最大功率值:double-long-unsigned,发生时间:date_time_s},'),
    ('2141', '月最大有功功率及发生时间', '2', '变量类', '属性', '2', '', '月最大有功功率及发生时间:array:,'),
    ('2200', '通信流量', '6', '变量类', '属性', '2', '', '通信流量:structure{当日通信流量:double-long-unsigned,当月通信流量:double-long-unsigned},'),
    ('2203', '供电时间', '6', '变量类', '属性', '2', '', '供电时间:structure{日供电累计时间:double-long-unsigned,月供电累计时间:double-long-unsigned},'),
    ...
    ('2505', '水温', '6', '变量类', '属性', '2', '', '水温:structure{供水温度:double-long-unsigned,回水温度:double-long-unsigned},'),
    ...
    ('3009', '电能表正向有功需量超限事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 电能表需量超限事件单元,'),
    ('3009', '电能表正向有功需量超限事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{触发下限:double-long-unsigned<kW,-4>,判定延时时间:unsigned<s,0>},'),
    ('300A', '电能表反向有功需量超限事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 电能表需量超限事件单元,'),
    ...
    ('300B', '电能表无功需量超限事件', '24', '事件类', '属性', '6', '事件记录表 1', '事件记录表 1:array 电能表需量超限事件单元,'),
    ('300B', '电能表无功需量超限事件', '24', '事件类', '属性', '7', '事件记录表 2', '事件记录表 2:array 电能表需量超限事件单元,'),
    ('300B', '电能表无功需量超限事件', '24', '事件类', '属性', '8', '事件记录表 3', '事件记录表 3:array 电能表需量超限事件单元,'),
    ('300B', '电能表无功需量超限事件', '24', '事件类', '属性', '9', '事件记录表 4', '事件记录表 4:array 电能表需量超限事件单元,'),
    ('300C', '电能表功率因数超下限事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ('300C', '电能表功率因数超下限事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{下限阀值:long<%,-1>,判定延时时间:unsigned<s,0>},'),
    ('300D', '电能表全失压事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ('300D', '电能表全失压事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{},'),
    ('300E', '电能表辅助电源掉电事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ('300E', '电能表辅助电源掉电事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{判定延时:unsigned<s,0>},'),
    ('300F', '电能表电压逆相序事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ('300F', '电能表电压逆相序事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{判定延时:unsigned<s,0>},'),
    ('3010', '电能表电流逆相序事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ('3010', '电能表电流逆相序事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{判定延时:unsigned<s,0>},'),
    ('3011', '电能表掉电事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ('3011', '电能表掉电事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{判定延时:unsigned<s,0>},'),
    ('3012', '电能表编程事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 编程记录事件单元,'),
    ('3012', '电能表编程事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{},'),
    ('3013', '电能表清零事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ('3013', '电能表清零事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{},'),
    ('3014', '电能表需量清零事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ('3014', '电能表需量清零事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{},'),
    ('3015', '电能表事件清零事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 事件清零事件记录单元,'),
    ('3015', '电能表事件清零事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{},'),
    ('3016', '电能表校时事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ('3016', '电能表校时事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{},'),
    ('3017', '电能表时段表编程事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 电能表时段表编程事件,'),
    ('3017', '电能表时段表编程事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{},'),
    ('3018', '电能表时区表编程事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ('3018', '电能表时区表编程事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{},'),
    ('3019', '电能表周休日编程事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ('3019', '电能表周休日编程事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{},'),
    ('301A', '电能表结算日编程事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ('301A', '电能表结算日编程事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{},'),
    ('301B', '电能表开盖事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ('301B', '电能表开盖事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{},'),
    ('301C', '电能表开端钮盒事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ('301C', '电能表开端钮盒事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{},'),
    ('301D', '电能表电压不平衡事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ('301D', '电能表电压不平衡事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{限值:long<%,-2>,判定延时时间:unsigned<s,0>},'),
    ('301E', '电能表电流不平衡事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ('301E', '电能表电流不平衡事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{限值:long<%,-2>,判定延时时间:unsigned<s,0>},'),
    ('301F', '电能表跳闸事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ('301F', '电能表跳闸事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{},'),
    ('3020', '电能表合闸事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ('3020', '电能表合闸事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{},'),
    ('3021', '电能表节假日编程事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ('3021', '电能表节假日编程事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{},'),
    ('3022', '电能表有功组合方式编程事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ...
    ('3024', '电能表费率参数表编程事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ('3024', '电能表费率参数表编程事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{},'),
    ('3025', '电能表阶梯表编程事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ('3025', '电能表阶梯表编程事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{},'),
    ('3026', '电能表密钥更新事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ...
    ('3028', '电能表购电记录', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ...
    ('302A', '电能表恒定磁场干扰事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ('302A', '电能表恒定磁场干扰事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{判定延时:unsigned<s,0>},'),
    ('302B', '电能表负荷开关误动作事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ('302B', '电能表负荷开关误动作事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{判定延时:unsigned<s,0>},'),
    ('302C', '电能表电源异常事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ('302C', '电能表电源异常事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{判定延时:unsigned<s,0>},'),
    ('302D', '电能表电流严重不平衡事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ('302D', '电能表电流严重不平衡事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{限值:long<%,-2>判定延时时间:unsigned<s,0>},'),
    ('302E', '电能表时钟故障事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ('302E', '电能表时钟故障事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{判定延时:unsigned<s,0>},'),
    ('302F', '电能表计量芯片故障事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ('302F', '电能表计量芯片故障事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{判定延时:unsigned<s,0>},'),
    ('3030', '通信模块变更事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 通信模块变更事件单元,'),
    ('3030', '通信模块变更事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{判定延时:unsigned<s,0>},'),
    ('3100', '终端初始化事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ('3100', '终端初始化事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{},'),
    ('3101', '终端版本变更事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ('3101', '终端版本变更事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{},'),
    ('3104', '终端状态量变位事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ('3104', '终端状态量变位事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{},'),
    ('3105', '电能表时钟超差事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 电能表时钟超差记录单元,'),
    ('3105', '电能表时钟超差事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{异常判别阈值:long-unsigned<秒>,关联采集任务号:unsigned},'),
    ('3106', '终端停/上电事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 停,'),
    ...
    ('3107', '终端直流模拟量越上限事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ('3107', '终端直流模拟量越上限事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{直流模拟量上限:double-long},'),
    ('3108', '终端直流模拟量越下限事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ('3108', '终端直流模拟量越下限事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{直流模拟量下限:double-long},'),
    ('3109', '终端消息认证错误事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ('3109', '终端消息认证错误事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{},'),
    ('310A', '设备故障记录', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ...
    ('310B', '电能表示度下降事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ('310B', '电能表示度下降事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{关联采集任务号:unsigned},'),
    ('310C', '电能量超差事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ('310C', '电能量超差事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{阈值:double-long-unsigned<%,0>,关联采集任务号:unsigned},'),
    ('310D', '电能表飞走事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ('310D', '电能表飞走事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{阈值:double-long-unsigned<%,0>,关联采集任务号:unsigned},'),
    ('310E', '电能表停走事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ('310E', '电能表停走事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{阈值:TI,关联采集任务号:unsigned},'),
    ('310F', '终端抄表失败事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ('310F', '终端抄表失败事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{重试轮次:unsigned,关联采集任务号:unsigned},'),
    ('3110', '月通信流量超限事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ('3110', '月通信流量超限事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{通信流量门限:double-long-unsigned<byte>},'),
    ('3111', '发现未知电能表事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 发现未知电能表事件单元,'),
    ...
    ('3114', '终端对时事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准事件记录单元,'),
    ('3114', '终端对时事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{},'),
    ('3115', '遥控跳闸记录', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 遥控事件记录单元,'),
    ...
    ('3117', '输出回路接入状态变位事件记录', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准,'),
    ('3117', '输出回路接入状态变位事件记录', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{},'),
    ('3118', '终端编程记录', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 编程记录事件单元,'),
    ('3118', '终端编程记录', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{},'),
    ('3119', '终端电流回路异常事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准,'),
    ('3119', '终端电流回路异常事件', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{}事件发生源∷=:enum[短路(0),开路(1)],'),
    ('311A', '电能表在网状态切换事件', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 电能表在网状态切换事件单元,'),
    ...
    ('3200', '功控跳闸记录', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 功控跳闸记录单元,'),
    ...
    ('3202', '购电参数设置记录', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 标准,'),
    ('3202', '购电参数设置记录', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{},'),
    ('3203', '电控告警事件记录', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array 电控告警事件单元,'),
    ('3203', '电控告警事件记录', '7', '事件类', '属性', '6', '配置参数', '配置参数:structure{},'),
    ('3300', '通道上报状态', '8', '事件类', '属性', '2', '', '通道上报状态:array:structure{通道:OAD,上报状态:unsigned},'),
    ('3301', '标准事件记录单元', '8', '事件类', '属性', '2', '', '标准事件记录单元:structure{事件记录序号:double-long-unsigned,事件发生时间:date_time_s,事件结束时间:date_time_s,事件发生源instance-specific,事件上报状态:array通道上报状态,第1个关联对象属性的数据:Data,…第n个关联对象属性的数据:Data},'),
    ('3302', '编程记录事件单元', '8', '事件类', '属性', '2', '', '编程记录事件单元:structure{事件记录序号:double-long-unsigned,事件发生时间:date_time_s,事件结束时间:date_time_s,事件发生源:NULL,事件上报状态:array通道上报状态,编程对象列表:array:OAD,第1个关联对象属性的数据:Data,…第n个关联对象属性的数据:Data},'),
    ('3303', '发现未知电能表事件单元', '8', '事件类', '属性', '2', '', '发现未知电能表事件单元:structure{事件记录序号:double-long-unsigned,事件发生时间:date_time_s,事件结束时间:date_time_s,事件发生源:NULL,事件上报状态:array通道上报状态,搜表结果:array一个搜表结果,},'),
    ('3304', '跨台区电能表事件单元', '8', '事件类', '属性', '2', '', '跨台区电能表事件单元:structure{事件记录序号:double-long-unsigned,事件发生时间:date_time_s,事件结束时间:date_time_s,事件发生源:NULL,事件上报状态:array通道上报状态,跨台区搜表结果:array一个跨台区结果,第1个关联对象属性的数据:Data,…第n个关联对象属性的数据:Data},'),
    ('3305', '功控跳闸记录单元', '8', '事件类', '属性', '2', '', '功控跳闸记录单元:structure{事件记录序号:double-long-unsigned,事件发生时间:date_time_s,事件结束时间:date_time_s,事件发生源:OI,事件上报状态:array通道上报状态,事件发生后2分钟功率:long64(W,换算-1),控制对象:OI,跳闸轮次:bit-string(SIZE(8)),功控定值:long64<kWh,换算-4>,跳闸发生前总加有功功率:long64<kW,换算-4>,第1个关联对象属性的数据:Data,…第n个关联对象属性的数据:Data},'),
    ('3306', '电控跳闸记录单元', '8', '事件类', '属性', '2', '', '电控跳闸记录单元:structure{事件记录序号:double-long-unsigned,事件发生时间:date_time_s,事件结束时间:date_time_s,事件发生源:OI,事件上报状态:array通道上报状态,控制对象:OI,跳闸轮次:bit-string(SIZE(8)),电控定值:long64<kWh,换算-4>,跳闸发生时总加电能量:long64<kwh/元,换算-4>,第1个关联对象属性的数据:Data,…第n个关联对象属性的数据:Data},'),
    ('3307', '电控告警事件单元', '8', '事件类', '属性', '2', '', '电控告警事件单元:structure{事件记录序号:double-long-unsigned,事件发生时间:date_time_s,事件结束时间:date_time_s,事件发生源:OI,事件上报状态:array通道上报状态,控制对象:OI,电控定值:long64<kWh,换算-4>,第1个关联对象属性的数据:Data,…第n个关联对象属性的数据:Data},'),
    ('3308', '电能表需量超限事件单元', '8', '事件类', '属性', '2', '', '电能表需量超限事件单元:structure{事件记录序号:double-long-unsigned,事件发生时间:date_time_s,事件结束时间:date_time_s,事件发生源:NULL,事件上报状态:array通道上报状态,超限期间需量最大值:double-long-unsigned,超限期间正向有功需量最大值:double-long-unsigned,超限期间需量最大值发生时间:date_time_s,第1个关联对象属性的数据:Data,…第n个关联对象属性的数据:Data},'),
    ('3309', '停/上电事件记录单元', '8', '事件类', '属性', '2', '', '停/上电事件记录单元:structure{事件记录序号:double-long-unsigned,事件发生时间:date_time_s,事件结束时间:date_time_s,事件发生源:enum[停电(0),上电(1)],事件上报状态:array通道上报状态,属性标志:bit-string<SIZE(8)>,第1个关联对象属性的数据:Data,…第n个关联对象属性的数据:Data},'),
    ('330A', '遥控事件记录单元', '8', '事件类', '属性', '2', '', '遥控事件记录单元:structure{事件记录序号:double-long-unsigned,事件发生时间:date_time_s,事件结束时间:date_time_s,事件发生源:OAD,事件上报状态:array通道上报状态,控后2分钟总加组功率:array:long64,第1个关联对象属性的数据:Data,…第n个关联对象属性的数据:Data},'),
    ('330B', '有功总电能量差动越限事件记录单元', '8', '事件类', '属性', '2', '', '有功总电能量差动越限事件记录单元:structure{事件记录序号:double-long-unsigned,事件发生时间:date_time_s,事件结束时间:date_time_s,事件发生源:unsigned,事件上报状态:array通道上报状态,越限时对比总加组有功总电能量:long64<kWh,-4>,越限时参照总加组有功总电能量:long64<kWh,-4>,越限时差动越限相对偏差值:integer<%,0>,越限时差动越限绝对偏差值:long64<kWh,-4>},'),
    ('330C', '事件清零事件记录单元', '8', '事件类', '属性', '2', '', '事件清零事件记录单元:structure{事件记录序号:double-long-unsigned,事件发生时间:date_time_s,事件结束时间:date_time_s,事件发生源:NULL,事件上报状态:array通道上报状态,事件清零列表:array:OMD},'),
    ('330D', '终端对电表校时记录单元', '8', '事件类', '属性', '2', '', '终端对电表校时记录单元:structure{事件记录序号:double-long-unsigned,事件发生时间:date_time_s,事件结束时间:date_time_s,事件发生源:TSA,事件上报状态:array通道上报状态,校时前时钟:date_time_s,时钟误差:integer<秒,0>},'),
    ('330E', '电能表在网状态切换事件单元', '8', '事件类', '属性', '2', '', '电能表在网状态切换事件单元:structure{事件记录序号:double-long-unsigned,事件发生时间:date_time_s,事件结束时间:date_time_s,事件发生源:NULL,事件上报状态:array通道上报状态,状态变迁事件:array:structure{电能表地址:TSA,在网状态:bool}},'),
    ('330F', '电能表数据变更监控记录单元', '8', '事件类', '属性', '2', '', '电能表数据变更监控记录单元:structure{事件记录序号:double-long-unsigned,事件发生时间:date_time_s,事件结束时间:date_time_s,事件发生源:TSA,事件上报状态:array通道上报状态,监控数据对象:CSD,变化前数据:Data,变化后数据:Data},'),
    ('3310', '异常插卡事件记录单元', '8', '事件类', '属性', '2', '', '异常插卡事件记录单元:structure{事件记录序号:double-long-unsigned,事件发生时间:date_time_s,事件结束时间:date_time_s,事件发生源:NULL,事件上报状态:array通道上报状态,卡序列号:octet-string,插卡错误信息字:unsigned,插卡操作命令头:octet-string,插卡错误响应状态:long-unsigned,第1个关联对象属性的数据:Data,…第n个关联对象属性的数据:Data},'),
    ('3311', '退费事件记录单元', '8', '事件类', '属性', '2', '', '退费事件记录单元:structure{事件记录序号:double-long-unsigned,事件发生时间:date_time_s,事件结束时间:date_time_s,事件发生源:NULL,事件上报状态:array通道上报状态,退费金额:double-long-unsigned<元,-2>,第1个关联对象属性的数据:Data,…第n个关联对象属性的数据:Data},'),
    ('3312', '', '', '事件类', '属性', '0', '', ''),
    ('3312', '', '', '事件类', '属性', '2', '通信模块变更事件单元', '通信模块变更事件单元:structure{事件记录序号:double-long-unsigned,事件发生时间:date_time_s,事件结束时间:date_time_s,事件发生源:OAD,事件上报状态:array通道上报状态,模块对应的通信地址:octet-string,变更前的模块描述符:visible-string,变更后的模块描述符:visible-string},'),
    ('3313', '', '8', '事件类', '属性', '0', '', ''),
    ('3313', '', '8', '事件类', '属性', '2', '', ':structure{事件记录序号:double-long-unsigned,事件发生时间:date_time_s,事件结束时间:date_time_s,事件发生源:TSA,事件上报状态:array通道上报状态,电能表时钟DATE:TIME_S,终端当前时钟DATE:TIME_S,第1个关联对象属性的数据:Data,…第n个关联对象属性的数据:Data},'),
    ('3314', '电能表时段表编程事件', '', '事件类', '属性', '0', '', ''),
    ('3314', '电能表时段表编程事件', '', '事件类', '属性', '2', '', '电能表时段表编程事件:structure{事件记录序号:double-long-unsigned,事件发生时间:date_time_s,事件结束时间:date_time_s,事件发生源:NULL,事件上报状态:array通道上报状态,编程时段表对象:OAD,编程前时段表内容日时段表,第1个关联对象属性的数据:Data,…第n个关联对象属性的数据:Data}日时段表∷=:array:structure{时:unsigned,分:unsigned,费率号:unsigned},'),
    ('3315', '电能表节假日编程事件记录单元', '', '事件类', '属性', '0', '', ''),
    ('3315', '电能表节假日编程事件记录单元', '', '事件类', '属性', '2', '', '电能表节假日编程事件记录单元:structure{事件记录序号:double-long-unsigned,事件发生时间:date_time_s,事件结束时间:date_time_s,事件发生源:NULL,事件上报状态:array通道上报状态,编程节假日对象:OAD,编程前节假日内容公共假日,第1个关联对象属性的数据:Data,…第n个关联对象属性的数据:Data}公共假日∷=:structure{日期:date,日时段表号:unsigned},'),
    ...
    ('4000', '日期时间', '8', '参变量类', '属性', '4', '精准校时参数', '精准校时参数:structure{最近心跳时间总个数:unsigned,最大值剔除个数:unsigned,最小值剔除个数:unsigned,通讯延时阈值:unsigned<秒>,最少有效个数:unsigned},'),
    ...
    ('4007', 'LCD参数', '8', '参变量类', '属性', '2', '', 'LCD参数:structure{上电全显时间:unsigned,背光点亮时间:long-unsigned(按键时背光点亮时间),显示查看背光点亮时间:long-unsigned,无电按键屏幕驻留最大时间:long-unsigned,显示电能小数位数:unsigned,显示功率<最大需量>小数位数:unsigned,液晶①②字样意义:unsigned},'),
    ...
    ('4014', '当前套时区表', '8', '参变量类', '属性', '2', '', '当前套时区表:array:structure{月:unsigned,日:unsigned,日时段表号:unsigned},'),
    ('4015', '备用套时区表', '8', '参变量类', '属性', '0', '', ''),
    ('4016', '当前套日时段表', '8', '参变量类', '属性', '2', '', '当前套日时段表:array:structure{时:unsigned,分:unsigned,费率号:unsigned},'),
    ('4017', '备用套日时段表', '8', '参变量类', '属性', '0', '', ''),
    ('4018', '当前套费率电价', '8', '参变量类', '属性', '2', '', '当前套费率电价:array 费率电价<元/kWh|-4>,'),
    ('4019', '备用套费率电价', '8', '参变量类', '属性', '2', '', '备用套费率电价:array 费率电价<元/kWh|-4>,'),
    ('401A', '当前套阶梯电价', '8', '参变量类', '属性', '2', '阶梯参数', '阶梯参数:structure{阶梯值数组:array阶梯值,阶梯电价数组:array阶梯电价,阶梯结算日数组:array:structure{月:unsigned,日:unsigned,时:unsigned}}阶梯值∷=:double-long-unsigned阶梯电价∷=:double-long-unsigned,'),
    ('401B', '备用套阶梯电价', '8', '参变量类', '属性', '0', '', ''),
    ('401C', '电流互感器变比', '8', '参变量类', '属性', '2', '', '电流互感器变比:double-long-unsigned<|-2>,'),
    ('401D', '电压互感器变比', '8', '参变量类', '属性', '2', '', '电压互感器变比:double-long-unsigned<|-2>,'),
    ('401E', '报警金额限值', '8', '参变量类', '属性', '2', '参数', '参数:structure{报警金额限值1:double-long-unsigned,报警金额限值2:double-long-unsigned,},'),
    ('401F', '其它金额限值', '8', '参变量类', '属性', '2', '参数', '参数:structure{透支金额限值:double-long-unsigned,囤积金额限值:double-long-unsigned,合闸允许金额限值:double-long-unsigned,},'),
    ('4020', '报警电量限值', '8', '参变量类', '属性', '2', '', '报警电量限值:structure{报警电量限值1:double-long-unsigned,报警电量限值2:double-long-unsigned,},'),
    ('4021', '其它电量限值', '8', '参变量类', '属性', '2', '', '其它电量限值:structure{囤积电量限值:double-long-unsigned,透支电量限值:double-long-unsigned,合闸允许电量限值:double-long-unsigned,},'),
    ('4022', '插卡状态字', '8', '参变量类', '属性', '2', '', '插卡状态字:bit-string(SIZE(16)),'),
    ('4024', '剔除', '8', '参变量类', '属性', '2', '', '剔除:enum[剔除投入<1>,剔除解除<2>],'),
    ('4025', '采集器升级结果表', '8', '参变量类', '属性', '2', '升级结果列表', '升级结果列表:array 采集器升级结果,'),
    ('4025', '采集器升级结果表', '8', '参变量类', '属性', '3', '采集器升级控制参数', '采集器升级控制参数:structure{允许一次升级广播轮次数:unsigned允许一次升级点对点补发天数:unsigned},'),
    ('4026', '采集器升级结果', '8', '参变量类', '属性', '2', '升级结果', '升级结果:structure{序号:long-unsigned,采集器地址:TSA,采集器升级结果标识:unsigned,补发开始时间:date_time_s,升级成功时间:date_time_s,广播成功块数:long-unsigned,补发块数:long-unsigned,升级前采集器版本VersionInfo,升级后采集器版本VersionInfo},'),
    ...
    ('410C', 'ABC各相电导系数', '8', '参变量类', '属性', '2', '', 'ABC各相电导系数:structure{A相电导:long<无,-3>,B相电导:long<无,-3>,C相电导:long<无,-3>},'),
    ('410D', 'ABC各相电抗系数', '8', '参变量类', '属性', '2', '', 'ABC各相电抗系数:structure{A相电抗:long<无,-3>,B相电抗:long<无,-3>,C相电抗:long<无,-3>},'),
    ('410E', 'ABC各相电阻系数', '8', '参变量类', '属性', '2', '', 'ABC各相电阻系数:structure{A相电阻:long<无,-3>,B相电阻:long<无,-3>,C相电阻:long<无,-3>},'),
    ('410F', 'ABC各相电纳系数', '8', '参变量类', '属性', '2', '', 'ABC各相电纳系数:structure{A相电纳:long<无,-3>,B相电纳:long<无,-3>,C相电纳:long<无,-3>},'),
    ...
    ('4204', '终端广播校时', '8', '参变量类', '属性', '3', '终端单地址广播校时参数', '终端单地址广播校时参数:structure{时钟误差阈值:integer<秒>,终端广播校时启动时间:time,是否启用:bool},'),
    ...
    ('4309', '热表', '19', '参变量类', '方法', '129', '机电同步(参数 1 ，参数 2)', '机电同步(参数 1 ，参数 2):double-long-unsigned,'),
    ('4400', '应用连接', '20', '参变量类', '属性', '0', '', ''),
    ('4401', '应用连接认证密码', '8', '参变量类', '属性', '2', '只写', '只写:visible-string,'),
    ...
    ('6000', '采集档案配置表', '11', '采集监控类', '方法', '127', 'Add(采集档案配置单元)', 'array:structure{配置序号:long-unsigned,基本信息:structure{通信地址:TSA,波特率:enum[300bps<0>,600bps<1>,1200bps<2>,2400bps<3>,4800bps<4>,7200bps<5>,9600bps<6>,19200bps<7>,38400bps<8>,57600bps<9>,115200bps<10>,自适应<255>],规约类型:enum[未知(0),DL/T645-1997<1>,DL/T645-2007<2>,DL/T698.45<3>,CJ/T188-2004<4>],端口:OAD,通信密码:octet-string,费率个数:unsigned,用户类型:unsigned,接线方式:enum[未知<0>,单相<1>,三相三线<2>,三相四线<3>],额定电压:long-unsigned<V|-1>,额定电流:long-unsigned<A|-1>},扩展信息:structure{采集器地址:TSA,资产号:octet-string,PT:long-unsigned,CT:long-unsigned},附属信息:array:structure{对象属性描述:OAD,属性值:Data}}'),
    ('6000', '采集档案配置表', '11', '采集监控类', '方法', '128', 'AddBatch(array 采集档案配置单元)', 'array:structure{配置序号:long-unsigned,基本信息:structure{通信地址:TSA,波特率:enum[300bps<0>,600bps<1>,1200bps<2>,2400bps<3>,4800bps<4>,7200bps<5>,9600bps<6>,19200bps<7>,38400bps<8>,57600bps<9>,115200bps<10>,自适应<255>],规约类型:enum[未知(0),DL/T645-1997<1>,DL/T645-2007<2>,DL/T698.45<3>,CJ/T188-2004<4>],端口:OAD,通信密码:octet-string,费率个数:unsigned,用户类型:unsigned,接线方式:enum[未知<0>,单相<1>,三相三线<2>,三相四线<3>],额定电压:long-unsigned<V|-1>,额定电流:long-unsigned<A|-1>},扩展信息:structure{采集器地址:TSA,资产号:octet-string,PT:long-unsigned,CT:long-unsigned},附属信息:array:structure{对象属性描述:OAD,属性值:Data}}'),
    ('6000', '采集档案配置表', '11', '采集监控类', '方法', '129', 'Update(配置序号，基本信息)', ''),
    ('6000', '采集档案配置表', '11', '采集监控类', '方法', '130', 'Update(配置序号，扩展信息，附属信息)', ''),
    ('6000', '采集档案配置表', '11', '采集监控类', '方法', '131', 'Delete(配置序号)', ''),
    ...
    ('6002', '搜表', '11', '采集监控类', '属性', '2', '所有搜表结果', '所有搜表结果:array 一个搜表结果,'),
    ('6002', '搜表', '11', '采集监控类', '属性', '5', '跨台区搜表结果', '跨台区搜表结果:array 一个跨台区结果,'),
    ...
    ('6002', '搜表', '11', '采集监控类', '方法', '127', '实时启动搜表(搜表时长)', '实时启动搜表(搜表时长):long-unsigned<分钟|>,'),
    ...
    ('6012', '任务配置表', '10', '采集监控类', '方法', '127', 'Add(array 任务配置单元)', 'array:structure{任务ID:unsigned,执行频率:TI,方案类型:enum[普通采集方案<1>,事件采集方案<2>,透明方案<3>,上报方案<4>,脚本方案<5>],方案编号:unsigned,开始时间:date_time_s,结束时间:date_time_s,延时:TI,执行优先级:unsigned,状态:enum[正常<1>,停用<2>],任务开始前脚本id:long-unsigned,任务完成后脚本id:long-unsigned,任务运行时段:structure{类型:enum[前闭后开<0>,前开后闭<1>,前闭后闭<2>,前开后开<3>],时段表:array:structure{起始小时:unsigned,起始分钟:unsigned,结束小时:unsigned,结束分钟:unsigned}},}'),
    ('6012', '任务配置表', '10', '采集监控类', '方法', '128', 'Delete(array 任务 ID)', ''),
    ('6012', '任务配置表', '10', '采集监控类', '方法', '129', 'Clear()', ''),
    ('6012', '任务配置表', '10', '采集监控类', '方法', '130', 'Update(任务 ID ，状态)', ''),
    ('6013', '任务配置单元', '8', '采集监控类', '属性', '2', '任务配置单元', '任务配置单元:array:structure{任务ID:unsigned,执行频率:TI,方案类型:enum[普通采集方案<1>,事件采集方案<2>,透明方案<3>,上报方案<4>,脚本方案<5>],方案编号:unsigned,开始时间:date_time_s,结束时间:date_time_s,延时:TI,执行优先级:unsigned,状态:enum[正常<1>,停用<2>],任务开始前脚本id:long-unsigned,任务完成后脚本id:long-unsigned,任务运行时段:structure{类型:enum[前闭后开<0>,前开后闭<1>,前闭后闭<2>,前开后开<3>],时段表:array:structure{起始小时:unsigned,起始分钟:unsigned,结束小时:unsigned,结束分钟:unsigned}},}'),
    ('6014', '普通采集方案集', '11', '采集监控类', '属性', '2', '', '普通采集方案集:array 普通采集方案,'),
    ('6014', '普通采集方案集', '11', '采集监控类', '方法', '127', 'Add(array 普通采集方案)', 'array:structure{方案编号:unsigned,存储深度:long-unsigned,采集方式:structure{采集类型:unsigned,采集内容:Data},记录列选择:array:CSD,电能表集合:MS,存储时标选择:enum[未定义<0>,任务开始时间<1>,相对当日0点0分<2>,相对上日23点59分<3>,相对上日0点0分<4>,相对当月1日0点0分<5>,数据冻结时标<6>相对上月月末0点0分<7>]}'),
    ...
    ('6015', '普通采集方案', '8', '采集监控类', '属性', '2', '普通采集方案', '普通采集方案:structure{方案编号:unsigned,存储深度:long-unsigned,采集方式:structure{采集类型:unsigned,采集内容:Data},记录列选择:array:CSD,电能表集合:MS,存储时标选择:enum[未定义<0>,任务开始时间<1>,相对当日0点0分<2>,相对上日23点59分<3>,相对上日0点0分<4>,相对当月1日0点0分<5>,数据冻结时标<6>相对上月月末0点0分<7>]}采集方式数据格式如下：采集类型采集内容表示0:NULL采集当前数据1:unsigned采集上第N次2:NULL按冻结时标采集3:TI按时标间隔采集4RetryMetering补抄RetryMetering∷=:structure{数据时标间隔:TI,补抄周期<上N次>:long-unsigned},'),
    ('6016', '事件采集方案集', '11', '采集监控类', '属性', '2', '', '事件采集方案集:array 事件采集方案,'),
    ...
    ('6016', '事件采集方案集', '11', '采集监控类', '方法', '130', 'UpdateReportFlag(方案编号，上报标识)', 'UpdateReportFlag(方案编号，上报标识):bool,'),
    ('6017', '事件采集方案', '8', '采集监控类', '属性', '2', '事件采集方案 Event acq plan', '事件采集方案 Event acq plan:structure{方案编号:unsigned,采集方式:structure{采集类型:unsigned,采集内容:Data}电能表集合:MS,上报标识:bool<True：立即上报,False：不上报>,存储深度:long-unsigned},'),
    ('6018', '透明方案集', '11', '采集监控类', '属性', '2', '', '透明方案集:array 透明方案,'),
    ('6018', '透明方案集', '11', '采集监控类', '方法', '127', 'Add(透明方案)', ''),
    ('6018', '透明方案集', '11', '采集监控类', '方法', '128', 'AddMeterFrame(方案编号，通信地址，方案控制标志，方案报文集)', ''),
    ('6018', '透明方案集', '11', '采集监控类', '方法', '129', 'Delete(方案编号， array 通信地址)', ''),
    ('6018', '透明方案集', '11', '采集监控类', '方法', '130', 'Delete(array 方案编号)', ''),
    ...
    ('601A', '透明方案结果集', '11', '采集监控类', '属性', '2', '', '透明方案结果集:array 一个透明方案结果,'),
    ...
    ('601C', '上报方案集', '11', '采集监控类', '属性', '2', '', '上报方案集:array 上报方案,'),
    ('601C', '上报方案集', '11', '采集监控类', '方法', '127', 'Add(array 上报方案)', ''),
    ('601C', '上报方案集', '11', '采集监控类', '方法', '128', 'Delete(array 方案编号)', ''),
    ('601C', '上报方案集', '11', '采集监控类', '方法', '129', 'Clear()', ''),
    ('601D', '上报方案', '8', '采集监控类', '属性', '2', '上报方案 report   plan', '上报方案 report   plan:structure{方案编号:unsigned,上报通道:array:OAD,上报响应超时时间:TI,最大上报次数:unsigned,上报内容strcuture{类型:unsigned,数据:Data}}上报内容：上报类型上报内容表示0:OAD对象属性数据1Record:Data上报记录型对象属性Record:Data∷=:structure{主对象属性描述符:OAD,记录型对象属性描述符:R:CSD,行选择:RSD},'),
    ('601E', '采集规则库', '11', '采集监控类', '属性', '2', '采集规则库', '采集规则库:array 采集规则,'),
    ('601E', '采集规则库', '11', '采集监控类', '方法', '127', 'Add(array 采集规则)', ''),
    ('601E', '采集规则库', '11', '采集监控类', '方法', '128', 'Delete(array:CSD)', ''),
    ...
    ('6032', '采集状态集', '11', '采集监控类', '属性', '2', '', '采集状态集:array 一个采集状态,'),
    ...
    ('6034', '采集任务监控集', '11', '采集监控类', '属性', '2', '', '采集任务监控集:array 采集任务监控单元,'),
    ...
    ('7000', '文件集合', '11', '集合类', '方法', '129', 'DeleteFile(文件名)', 'DeleteFile(文件名):visible-string,'),
    ...
    ('7010', '脚本集合', '11', '集合类', '属性', '2', '', '脚本集合:array 脚本,'),
    ('7010', '脚本集合', '11', '集合类', '方法', '127', 'Add(脚本)', ''),
    ('7010', '脚本集合', '11', '集合类', '方法', '128', 'Delete(脚本 id)', ''),
    ('7010', '脚本集合', '11', '集合类', '方法', '129', 'Execute(脚本 id)', ''),
    ('7010', '脚本集合', '11', '集合类', '方法', '130', 'Clear()', 'Clear():long-unsigned,'),
    ('7011', '脚本', '8', '集合类', '属性', '2', '', '脚本:脚本structure{脚本ID:long-unsigned,操作集:array一个操作},'),
    ('7012', '脚本执行结果集', '11', '集合类', '属性', '2', '', '脚本执行结果集:array 一个脚本执行结果,'),
    ('7013', '一个脚本执行结果', '8', '集合类', '属性', '2', '', '一个脚本执行结果:structure{脚本ID:long-unsigned,脚本执行时间:date_time_s,脚本执行结果集:array一个执行结果},'),
    ('7100', '扩展变量对象集合', '11', '集合类', '属性', '2', '', '扩展变量对象集合:扩展变量对象集合,'),
    ('7101', '扩展参变量对象集合', '11', '集合类', '属性', '2', '', '扩展参变量对象集合:扩展参变量对象集合,'),
    ('8000', '遥控远程遥控', '8', '控制类', '属性', '2', '配置参数', '配置参数:structure{继电器拉闸电流门限值:double-long-unsigned<A,换算-4>,超电流门限保护延时时间:long-unsigned<分钟,换算0>},'),
    ...
    ('8000', '遥控远程遥控', '8', '控制类', '方法', '129', '跳闸(参数)', '跳闸(参数):array:structure{继电器:OAD,告警延时:unsigned<分钟,0>,限电时间:long-unsigned<分钟,0；值为0表示永久限电>,自动合闸:bool<True：自动合闸；False：非自动合闸>},'),
    ...
    ('8001', '保电', '8', '控制类', '属性', '3', '', '保电:long-unsigned,'),
    ('8001', '保电', '8', '控制类', '属性', '4', '', '保电:long-unsigned,'),
    ('8001', '保电', '8', '控制类', '属性', '5', '', '保电:array:structure{起始时间<时>:unsigned,结束时间<时>:unsigned},'),
    ...
    ('8003', '一般中文信息', '11', '控制类', '方法', '127', '添加信息(序号，发布时间，信息内容)', '添加信息(序号，发布时间，信息内容):unsigned,'),
    ('8003', '一般中文信息', '11', '控制类', '方法', '128', '删除信息(序号)', ''),
    ('8004', '重要中文信息', '11', '控制类', '属性', '2', '', '重要中文信息:array ChineseInfo,'),
    ('8004', '重要中文信息', '11', '控制类', '方法', '127', '添加信息(序号，发布时间，信息内容)', '添加信息(序号，发布时间，信息内容):unsigned,'),
    ('8004', '重要中文信息', '11', '控制类', '方法', '128', '删除信息(序号)', ''),
    ('8100', '终端保安定值', '8', '控制类', '属性', '2', '', '终端保安定值:long64<W|-1>,'),
    ('8101', '终端功控时段', '8', '控制类', '属性', '2', '配置参数', '配置参数:array  ,'),
    ('8102', '功控告警时间', '8', '控制类', '属性', '2', '配置参数', '配置参数:array  <分钟）|>,'),
    ('8103', '时段功控', '13', '控制类', '属性', '2', '控制方案集', '控制方案集:array 时段功控配置单元,'),
    ('8103', '时段功控', '13', '控制类', '方法', '127', '时段功控方案切换(总加组对象，控制方案)', '时段功控方案切换(总加组对象，控制方案):OIstructure{时段功控投入标识:bit-string(SIZE(8)),时段功控定值方案号:unsigned},'),
    ('8104', '厂休控', '13', '控制类', '属性', '2', '控制方案集', '控制方案集:array 厂休控配置单元,'),
    ('8105', '营业报停控', '13', '控制类', '属性', '2', '控制方案集', '控制方案集:array 营业报停控配置单元,'),
    ('8106', '当前功率下浮控', '13', '控制类', '方法', '127', '投入(总加组对象，控制方案)', '投入(总加组对象，控制方案):OIstructure{当前功率下浮控定值滑差时间:unsigned<分钟>,当前功率下浮控定值浮动系数:integer<%>,控后总加有功功率冻结延时时间:unsigned<分钟>,当前功率下浮控的控制时间:unsigned<0.5小时>,当前功率下浮控第1轮告警时间:unsigned<分钟>,当前功率下浮控第2轮告警时间:unsigned<分钟>,当前功率下浮控第3轮告警时间:unsigned<分钟>,当前功率下浮控第4轮告警时间:unsigned<分钟>},'),
    ('8107', '购电控', '13', '控制类', '属性', '2', '控制方案集', '控制方案集:array 购电控配置单元,'),
    ('8108', '月电控', '13', '控制类', '属性', '2', '控制方案集', '控制方案集:array 月电控配置单元,'),
    ('8109', '时段功控配置单元', '8', '控制类', '属性', '2', '', '时段功控配置单元:structure{总加组对象:OI,方案标识:bit-string(SIZE(8)),第一套定值PowerCtrlParam,第二套定值PowerCtrlParam,第三套定值PowerCtrlParam,时段功控定值浮动系数:integer<%>}PowerCtrlParam∷=:structure{时段号:bit-string(SIZE(8)),时段1功控定值:long64<W,-1>,时段2功控定值:long64<W,-1>,时段3功控定值:long64<W,-1>,时段4功控定值:long64<W,-1>,时段5功控定值:long64<W,-1>,时段6功控定值:long64<W,-1>,时段7功控定值:long64<W,-1>,时段8功控定值:long64<W,-1>},'),
    ('810A', '厂休控配置单元', '8', '控制类', '属性', '2', '', '厂休控配置单元:structure{总加组对象:OI,厂休控定值:long64<W,-1>,限电起始时间:date_time_s<年=FFFFH,月=FFH,日=FFH>,限电延续时间:long-unsigned<分钟>,每周限电日:bit-string(SIZE(8))},'),
    ...
    ('810D', '月电控配置单元', '8', '控制类', '属性', '2', '', '月电控配置单元:structure{总加组对象:OI,月电量控定值:long64<kWh,-4>,报警门限值系数:unsigned<%>,月电量控定值浮动系数:integer<%>},'),
    ('810E', '控制对象', '8', '控制类', '属性', '0', '', ''),
    ('810F', '跳闸轮次', '8', '控制类', '属性', '0', '', ''),
    ('8110', '电控定值', '8', '控制类', '属性', '0', '', ''),
    ('F000', '文件分帧传输管理', '18', '文件传输类', '属性', '4', '文件内容', '文件内容:octet-string,'),
    ('F000', '文件分帧传输管理', '18', '文件传输类', '属性', '5', '当前指针', '当前指针:double-long-unsigned,'),
    ('F001', '文件分块传输管理', '18', '文件传输类', '属性', '4', '传输块状态字', '传输块状态字:bit-string,'),
    ('F001', '文件分块传输管理', '18', '文件传输类', '属性', '7', '启动传输(参数)', '启动传输(参数):structure{文件信息:structure,传输块大小:long-unsigned,校验:structure},'),
    ('F001', '文件分块传输管理', '18', '文件传输类', '属性', '8', '写文件(参数)', '写文件(参数):structure{块序号:long-unsigned,块数据:octet-string},'),
    ('F001', '文件分块传输管理', '18', '文件传输类', '属性', '9', '读文件(参数)', '读文件(参数):structure{块序号:long-unsigned}应答∷=:structure{块数据:octet-string},'),
    ('F001', '文件分块传输管理', '18', '文件传输类', '属性', '10', '软件比对(参数)', '软件比对(参数):structure{CPU编号:unsigned,密钥索引:unsigned,因子起始地址:double-long-unsigned,数据起始地址:double-long-unsigned,待加密数据长度:long-unsigned}应答∷=:structure{比对块数据:octet-string},'),
    ...
    ('F002', '文件扩展传输管理', '18', '文件传输类', '属性', '7', '从服务器下载(文件信息，协议类型)', '从服务器下载(文件信息，协议类型):enum[telnet+zmodem协议<0>,ftp协议<1>,sftp协议<2>,http协议<3>,https协议<4>],'),
    ('F002', '文件扩展传输管理', '18', '文件传输类', '属性', '8', '上传到服务器(文件信息，协议类型)', ''),
    ...
    ('F101', '安全模式参数', '8', 'ESAM接口类', '属性', '3', '为显式安全模式参数(设置值)', ''),
    ('F101', '安全模式参数', '8', 'ESAM接口类', '属性', '1', '复位(参数)', '复位(参数):integer,'),
    ('F101', '安全模式参数', '8', 'ESAM接口类', '方法', '127', '增加显式安全模式参数(对象标识，权限)', '增加显式安全模式参数(对象标识，权限):OI,'),
    ('F101', '安全模式参数', '8', 'ESAM接口类', '方法', '128', '删除显式安全模式参数(对象标识)', '删除显式安全模式参数(对象标识):OI,'),
    ('F101', '安全模式参数', '8', 'ESAM接口类', '方法', '129', '批量增加显式安全模式参数(array 安全模式参数)', '批量增加显式安全模式参数(array:structure{对象标识:OI,安全模式:long-unsigned},'),
    ...
    ('F200', 'RS232', '22', '输入输出设备类', '方法', '127', '配置端口(端口号，端口参数，端口功能)', '配置端口(端口号，端口参数，端口功能):OAD,'),
    ('F201', 'RS485', '22', '输入输出设备类', '属性', '0', '', ''),
    ('F202', '红外', '22', '输入输出设备类', '属性', '2', '设备对象列表', '设备对象列表:array:structure{端口描述符:visible-string,端口参数:COMDCB},'),
    ('F202', '红外', '22', '输入输出设备类', '方法', '127', '配置端口(端口号，端口参数)', '配置端口(端口号，端口参数):OAD,'),
    ('F203', '开关量输入', '22', '输入输出设备类', '属性', '2', '设备对象列表', '设备对象列表:array:structure{状态ST:unsigned,变位CD:unsigned},'),
    ('F203', '开关量输入', '22', '输入输出设备类', '属性', '4', '', '开关量输入:structure{开关量接入标志:bit-string(SIZE<8>)<bit0～bit7按顺序对位表示第1～8路状态量输入,置“1”：接入,置“0”：未接入。>,开关量属性标志:bit-string(SIZE<8>)<bit0～bit7按顺序对位表示第1～8路状态量输入,置“1”常开触点。置“0”：常闭触点。>},'),
    ('F204', '直流模拟量', '22', '输入输出设备类', '属性', '2', '设备对象列表', '设备对象列表:array 直流模拟量,'),
    ...
    ('F209', '载波/微功率无线接口', '22', '输入输出设备类', '属性', '2', '设备对象列表', '设备对象列表:array:structure{端口描述符:visible-string,通信参数:COMDCB,版本信息VersionInfo}VersionInfo∷=:structure{厂商代码:visible-string(SIZE(2)),芯片代码:visible-string(SIZE(2)),版本日期Date,软件版本:long-unsigned},'),
    ...
    ('F20C', '230M无线专网接口对象', '22', '输入输出设备类', '属性', '5', '', '230M无线专网接口对象:array 有效信号强度,'),
    ('F210', '', '22', '输入输出设备类', '属性', '0', '', ''),
    ('F20A', '脉冲输入设备', '22', '输入输出设备类', '属性', '2', '设备对象列表', '设备对象列表:array 脉冲输入端口描述符,'),
    ...
    ('F300', '自动轮显', '8', '显示类', '属性', '2', '', '自动轮显:structure{从节点序号:long-unsigned,从节点通信地址:octet-string,从节点描述符:visible-string},'),
...
ic_list = []
for row in ic_table:
    ic_list.append(iclass._make(row))
...
oi_list = []
for row in oi_table:
    oi_list.append(obj._make(row))


def get_structure(type, oad_omd_text):
    ...
    structure_text = oi_row[0].structure if oi_row and oi_row[0].structure else ic_row[0].structure if ic_row and ic_row[0] else ''
            ...
            if structure_text[0] in [',', ':', ' ']:
                ...
                if member_match.group(2): # enum
                    ...
                    if unit_match: # unit & scaler
                        ...
                        link_dict = {'unit': unit, 'scaler': scaler}
                structure_list.append(('', data_type, link_dict, []))
                structure_text = structure_text[len(member_match.group(0)):]
            elif re.match(r'.*?:', structure_text):
                member_match = re.search(r'(.*?):(.*?)(enum\[.*?\])?[:,\}\{]', structure_text)
...
def __get_explain(type, oad_omd_text):
    ...
    index_explain = ''
    if index > 0:
        member_info = get_structure(type, oad[:6] + '00')[0]
...
def get_oi_explain(oi_text):
    """get oad explain"""
    return __get_explain('oad', oi_text).get('oi', '未定义')


def get_oad_explain(oad_text):
    """get oad explain"""
    explain = __get_explain('oad', oad_text)
    if explain:
...
def get_omd_explain(omd_text):
    """get omd explain"""
    explain = __get_explain('omd', omd_text)
...
def get_rcsd_structure(m_list):
    ...
    for _ in range(num):
        ...
        offset += 1
        if csd_choice == '00':
            rcsd_structure.append(get_structure('oad', ''.join(m_list[offset: offset + 4])))
            offset += 4
        elif csd_choice == '01':
            link_type = get_oi_explain(''.join(m_list[offset: offset + 4]))
            link_load_structure = []
            offset += 4
            oad_num = int(m_list[offset], 16)
            offset += 1
            for _ in range(oad_num):
                link_load_structure += get_structure('oad', ''.join(m_list[offset: offset + 4]))
                offset += 4
...
if __name__ == '__main__':
    # while(True):
    #     input_text = input()
    #     print('>>>>>', get_oi_explain(input_text))
    #     print('>>>>>', get_oad_explain(input_text))
    #     print('>>>>>', get_omd_explain(input_text))

    ret = get_structure('oad', '60130200')
    # ret = get_oad_explain('4500020b')
    print('==========')
    print(ret)
