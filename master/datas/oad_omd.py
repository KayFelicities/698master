...
[
    ...
    ('8104', '厂休控', '13', '控制类', '属性', '2', '控制方案集', '控制方案集:array:structure{总加组对象:OI,厂休控定值:long64<W|-1>,限电起始时间:date_time_s<年=FFFFH,月=FFH,日=FFH>,限电延续时间:long-unsigned<分钟|0>,每周限电日:bit-string(SIZE(8))},'),
    ...
    ('8106', '当前功率下浮控', '13', '控制类', '方法', '127', '投入(总加组对象，控制方案)', '投入(总加组对象，控制方案):OIstructure{当前功率下浮控定值滑差时间:unsigned<分钟|0>|当前功率下浮控定值浮动系数:integer<%>,控后总加有功功率冻结延时时间:unsigned<分钟|0>|当前功率下浮控的控制时间:unsigned<0.5小时>,当前功率下浮控第1轮告警时间:unsigned<分钟|0>|当前功率下浮控第2轮告警时间:unsigned<分钟|0>,当前功率下浮控第3轮告警时间:unsigned<分钟|0>|当前功率下浮控第4轮告警时间:unsigned<分钟|0>},'),
...
def get_oi_explain(oi_text):
    """get oad explain"""
    return __get_explain('oad', oi_text + '0000').get('oi', '未定义')
...
if __name__ == '__main__':
    ...
    # ret = get_structure('oad', '31060600')
    ret = get_oad_explain('2300')
    print('==========')
    print(ret)
