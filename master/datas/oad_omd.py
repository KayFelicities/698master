...
[
    ...
    ('3200', '功控跳闸记录', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array:structure{事件记录序号:double-long-unsigned,事件发生时间:date_time_s,事件结束时间:date_time_s,事件发生源:OI,事件上报状态:array:structure{通道:OAD,上报状态:unsigned},事件发生后2分钟功率:long64(W,换算-1),控制对象:OI,跳闸轮次:bit-string(SIZE(8)),功控定值:long64<kWh,换算-4>,跳闸发生前总加有功功率:long64<kW,换算-4>,第1个关联对象属性的数据:Data,…第n个关联对象属性的数据:Data},'),
    ...
    ('3203', '电控告警事件记录', '7', '事件类', '属性', '2', '事件记录表', '事件记录表:array:structure{事件记录序号:double-long-unsigned,事件发生时间:date_time_s,事件结束时间:date_time_s,事件发生源:OI,事件上报状态:array:structure{通道:OAD,上报状态:unsigned},控制对象:OI,电控定值:long64<kWh,换算-4>,第1个关联对象属性的数据:Data,…第n个关联对象属性的数据:Data},'),
    ...
    ('3305', '功控跳闸记录单元', '8', '事件类', '属性', '2', '', '功控跳闸记录单元:structure{事件记录序号:double-long-unsigned,事件发生时间:date_time_s,事件结束时间:date_time_s,事件发生源:OI,事件上报状态:array:structure{通道:OAD,上报状态:unsigned},事件发生后2分钟功率:long64(W,换算-1),控制对象:OI,跳闸轮次:bit-string(SIZE(8)),功控定值:long64<kWh,换算-4>,跳闸发生前总加有功功率:long64<kW,换算-4>,第1个关联对象属性的数据:Data,…第n个关联对象属性的数据:Data},'),
    ('3306', '电控跳闸记录单元', '8', '事件类', '属性', '2', '', '电控跳闸记录单元:structure{事件记录序号:double-long-unsigned,事件发生时间:date_time_s,事件结束时间:date_time_s,事件发生源:OI,事件上报状态:array:structure{通道:OAD,上报状态:unsigned},控制对象:OI,跳闸轮次:bit-string(SIZE(8)),电控定值:long64<kWh,换算-4>,跳闸发生时总加电能量:long64<kwh/元,换算-4>,第1个关联对象属性的数据:Data,…第n个关联对象属性的数据:Data},'),
    ('3307', '电控告警事件单元', '8', '事件类', '属性', '2', '', '电控告警事件单元:structure{事件记录序号:double-long-unsigned,事件发生时间:date_time_s,事件结束时间:date_time_s,事件发生源:OI,事件上报状态:array:structure{通道:OAD,上报状态:unsigned},控制对象:OI,电控定值:long64<kWh,换算-4>,第1个关联对象属性的数据:Data,…第n个关联对象属性的数据:Data},'),
    ...
    ('401A', '当前套阶梯电价', '8', '参变量类', '属性', '2', '阶梯参数', '阶梯参数:structure{阶梯值数组:array:double-long-unsigned<kWh|-2>,阶梯电价数组:array:double-long-unsigned<元/kWh|-4>,阶梯结算日数组:array:structure{月:unsigned,日:unsigned,时:unsigned}}'),
    ...
    ('6014', '普通采集方案集', '11', '采集监控类', '属性', '2', '', '普通采集方案集:array:structure{方案编号:unsigned,存储深度:long-unsigned,采集方式:structure{采集类型:unsigned,采集内容:Data},记录列选择:array:CSD,电能表集合:MS,存储时标选择:enum[未定义<0>,任务开始时间<1>,相对当日0点0分<2>,相对上日23点59分<3>,相对上日0点0分<4>,相对当月1日0点0分<5>,数据冻结时标<6>相对上月月末0点0分<7>]},'),
    ...
    ('6015', '普通采集方案', '8', '采集监控类', '属性', '2', '普通采集方案', '普通采集方案:structure{方案编号:unsigned,存储深度:long-unsigned,采集方式:structure{采集类型:unsigned,采集内容:Data},记录列选择:array:CSD,电能表集合:MS,存储时标选择:enum[未定义<0>,任务开始时间<1>,相对当日0点0分<2>,相对上日23点59分<3>,相对上日0点0分<4>,相对当月1日0点0分<5>,数据冻结时标<6>相对上月月末0点0分<7>]},'),
    ...
    ('8104', '厂休控', '13', '控制类', '属性', '2', '控制方案集', '控制方案集:array:structure{总加组对象:OI,厂休控定值:long64<W,-1>,限电起始时间:date_time_s<年=FFFFH,月=FFH,日=FFH>,限电延续时间:long-unsigned<分钟>,每周限电日:bit-string(SIZE(8))},'),
    ('8105', '营业报停控', '13', '控制类', '属性', '2', '控制方案集', '控制方案集:array:structure{总加组对象:OI,报停起始时间:date_time_s<时=FFH,分=FFH>,报停结束时间:date_time_s<时=FFH,分=FFH>,报停控功率定值:long64<W,-1>},'),
    ...
    ('8108', '月电控', '13', '控制类', '属性', '2', '控制方案集', '控制方案集:array:structure{总加组对象:OI,月电量控定值:long64<kWh,-4>,报警门限值系数:unsigned<%>,月电量控定值浮动系数:integer<%>},'),
    ...
    ('F20C', '230M无线专网接口对象', '22', '输入输出设备类', '属性', '5', '', '230M无线专网接口对象:array:integer<dBμV|>,'),
...
if __name__ == '__main__':
    ...
    ret = get_structure('oad', '20290200')
