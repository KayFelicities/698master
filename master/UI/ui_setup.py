...
class MasterWindowUi():
    ...
    def setup_ui(self):
        ...
        self.open_trans_action = QtGui.QAction('&打开日志分析器', self)
        ...
        self.welcome_info = QtGui.QLabel()
        self.welcome_info.setText('<p><b>欢迎使用</b></p>')
        ...
        self.quick_vbox.addWidget(self.welcome_info)
        ...
        self.box_hsplitter.addWidget(self.explain_box)
