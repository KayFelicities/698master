...
class TransWindowUi():
    ...
    def setup_ui(self):
        ...
        self.open_action = QtWidgets.QAction('&打开...', self)
        self.open_action.setShortcut('Ctrl+o')
        self.reload_action = QtWidgets.QAction('&重新载入', self)
        self.reload_action.setShortcut('Ctrl+r')
        self.clear_action = QtWidgets.QAction('&清空', self)
        self.clear_action.setShortcut('Ctrl+l')
        self.find_action = QtWidgets.QAction('查找', self)
        self.find_action.setShortcut('Ctrl+f')
        self.next_msg_action = QtWidgets.QAction('跳至下一条报文', self)
        self.next_msg_action.setShortcut('Ctrl+d')
        self.priv_msg_action = QtWidgets.QAction('跳至上一条报文', self)
        ...
        self.input_w = QtWidgets.QWidget()
        ...
        self.input_vbox = QtWidgets.QVBoxLayout(self.input_w)
        ...
        self.output_vbox = QtWidgets.QVBoxLayout(self.output_w)
        self.output_vbox.setContentsMargins(0, 0, 0, 0)
        self.output_vbox.setSpacing(1)
        self.output_vspliter = QtWidgets.QSplitter(QtCore.Qt.Vertical)
        ...
        self.proc_bar = QtWidgets.QProgressBar()
        # self.proc_bar.setEnabled(True)
        self.proc_bar.setMinimumSize(QtCore.QSize(200, 0))
        self.proc_bar.setSizePolicy(QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed))
